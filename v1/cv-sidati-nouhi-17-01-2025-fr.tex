...
\textbf{LinkedIn:} \href{https://linkedin.com/in/sidati-nouhi/}{linkedin.com/in/sidati-nouhi/}}
...
\section{Expérience}
  \resumeSubHeadingListStart
    ...
    {Eurafric Information}{Casablanca, Maroc}
      ...
      {Création d'interfaces utilisateur responsives avec TypeScript React/Angular, intégrant des patterns UI/UX modernes et une architecture modulaire.}
...
\section{Stack Technique}
 \resumeSubHeadingListStart
   \item{
      \textbf{Langages}{: Java, C, C++, JavaScript, TypeScript, SQL, HTML, CSS, Bash}
      \hfill
      \textbf{Base de Données:} {OracleDB, MySQL, PostgreSQL, Redis}
      \hfill
      \textbf{Frameworks \& Outils}{: Spring, Spring Boot, Angular, React, Git, Gitlab, Github, Docker, Jenkins, JUnit, Sonar, SSH, Linux, aws.}
  }
 \resumeSubHeadingListEnd
